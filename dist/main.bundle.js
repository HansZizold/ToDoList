...
/* harmony import */ var _modules_clearcompleted_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
/* harmony import */ var _modules_reorder_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
...
document.addEventListener('click', (element) => {
  ...
  element.target.classList.contains('trash-active')) {
    ...
    (0,_modules_indexnormal_js__WEBPACK_IMPORTED_MODULE_2__["default"])(document.querySelectorAll('.checkbox'));
...
document.querySelectorAll('.task-container').forEach((task) => {
  ...
  task.addEventListener('drop', () => {
    ...
    taskArray = (0,_modules_reorder_js__WEBPACK_IMPORTED_MODULE_7__["default"])(dragStartIndex - 1, dragEndIndex - 1, taskArray);
    // Fix indexes
    ...
    taskArray.forEach((e) => (0,_modules_addtask_js__WEBPACK_IMPORTED_MODULE_5__["default"])(e.description));
  });
});
...
const indexNormalization = (checkbox) => {
  checkbox.forEach((e, i) => e.parentElement.id = i + 1);
};
